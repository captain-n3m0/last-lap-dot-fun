    ...
    <div className="min-h-screen bg-[var(--bg)]" data-testid="leaderboard-page">
      ...
      <main className="max-w-[1100px] mx-auto px-6 lg:px-10 py-12">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
          <div>
            <h1 className="font-brush text-[44px] sm:text-[64px] leading-none">
          ...
          {data.you && (
            <div className="card-ll px-5 py-3 self-start sm:self-auto">
        ...
        <div className="card-ll p-4">
          ...
          <div className="space-y-1">
            {data.top.map((e) => (
              <div key={e.rank}
                className={`grid grid-cols-[28px_32px_1fr_72px] sm:grid-cols-[40px_40px_1fr_120px_80px_80px] gap-3 px-3 py-3 items-center rounded ${e.is_you ? "border border-[var(--purple)] bg-[var(--purple)]/5" : "hover:bg-[var(--bg-card-2)]"}`}
