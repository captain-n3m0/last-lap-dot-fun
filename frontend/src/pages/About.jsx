  ...
  return (
    <div className="min-h-screen bg-[var(--bg)]" data-testid="about-page">
      ...
      <main className="max-w-[900px] mx-auto px-6 lg:px-10 py-16">
        <h1 className="font-brush text-[44px] sm:text-[64px] leading-none mb-6">
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-3">
          <Link to="/" className="btn-primary-ll py-3 px-6 w-full sm:w-auto" data-testid="about-cta-dashboard">ENTER THE TRACK</Link>
          {!user && <Link to="/register" className="btn-ghost-ll py-3 px-6 w-full sm:w-auto" data-testid="about-cta-register">JOIN THE GRID</Link>}
        </div>
      </main>
      {user && <Footer />}
    </div>
